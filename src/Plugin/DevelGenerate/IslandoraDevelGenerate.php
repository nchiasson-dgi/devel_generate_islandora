...
/**
 * Provides an IslandoraDevelGenerate plugin.
 *
 * @DevelGenerate(
 *   id = "islandora",
 *   label = @Translation("Islandora Objects"),
 *   description = @Translation("Generate a given number of Islandora content. Optionally delete current Islandora content."),
 *   url = "islandora",
 ...
 * )
 */
class IslandoraDevelGenerate extends DevelGenerateBase implements ContainerFactoryPluginInterface {
